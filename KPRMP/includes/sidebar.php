...
function hasTabAccess($tab, $role) {
    $permissions = [
        'admin' => ['dashboard', 'keanggotaan', 'ritel', 'kasir', 'logistik', 'gudang', 'permodalan', 'pendanaan_sal', 'jaminan_desa', 'simpan_pinjam', 'shu', 'info_desa'],
        'pengawas' => ['dashboard', 'keanggotaan', 'ritel', 'logistik', 'gudang', 'permodalan', 'pendanaan_sal', 'jaminan_desa', 'simpan_pinjam', 'shu', 'info_desa'],
        'developer' => ['dashboard', 'keanggotaan', 'ritel', 'kasir', 'logistik', 'gudang', 'permodalan', 'pendanaan_sal', 'jaminan_desa', 'simpan_pinjam', 'shu', 'info_desa'],
        'ritel' => ['dashboard', 'ritel', 'kasir', 'logistik', 'info_desa'],
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Kasir Ritel -->
        <?php if (hasTabAccess('kasir', $role)): ?>
        <a href="#kasir" class="nav-item" data-tab="kasir">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <rect x="2" y="2" width="20" height="20" rx="2" ry="2" stroke="currentColor" fill="none" stroke-width="2"></rect>
                <line x1="2" y1="8" x2="22" y2="8" stroke="currentColor" stroke-width="2"></line>
                <line x1="6" y1="12" x2="6.01" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="10" y1="12" x2="10.01" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="14" y1="12" x2="14.01" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="18" y1="12" x2="18.01" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="6" y1="16" x2="6.01" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="10" y1="16" x2="10.01" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="14" y1="16" x2="14.01" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
                <line x1="18" y1="16" x2="18.01" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>
            </svg>
            <span>Kasir Ritel</span>
        </a>
        <?php endif; ?>
